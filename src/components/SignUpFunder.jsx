...
const SignUpFunder = (props) => {
  ...
  const submitButton = (e) => {
    e.preventDefault();
    axios
      .post("http://127.0.0.1:8000/api/auth/registerFunder", inputField)
      .then((data) => {
    ...
    <div>
      ...
      >
        ...
        <div className="accept-terms">
          <input type="checkbox" className="me-2" name="" id="" />I have read
